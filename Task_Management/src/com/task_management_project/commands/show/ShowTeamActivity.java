...
public class ShowTeamActivity extends BaseCommand {
    ...
    protected String executeCommand(List<String> parameters) {
        ...
        for (Board board : team.getBoards()) {
            builder.append(team.getBoards().indexOf(board) + 1).append(". ").append(board.getLogs()).append(team.getBoards().indexOf(board) + 1 < team.getBoards().size() ? System.lineSeparator() : "");
        }
